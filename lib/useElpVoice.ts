...
const UI_FUNCTIONS = [
  ...
  {
    name: 'jarbis_command',
    description: 'Invoke a native JARBIS executive capability directly by voice, including anticipatory forecasting, autonomous commitment fulfilment, and approval-gated external actions.',
    parameters: {
      type: 'object',
      properties: {
        command: { type: 'string', enum: ['mission', 'attention', 'daily_briefing', 'meeting_prep', 'radar', 'relationships', 'relationship', 'negotiation', 'ledger', 'commitments', 'command_center', 'meeting_follow_up', 'meeting_schedule', 'fulfilment', 'fulfilment_run', 'anticipatory', 'anticipatory_run'] },
