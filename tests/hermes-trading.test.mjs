...
test('video-derived skills are exposed through the ELP skills API without replacing core skills',()=>{assert.match(skillsRoute,/HERMES_TRADING_SKILLS/);assert.match(skillsRoute,/ELP_SKILLS/);});
